...
def worker_main(
    ...
    TrainerClass = getattr(trainers_1, config.trainer)
...
def main(config: DictConfig):
    ...
    # Wrap the base model into your multi-head model if there is more than one dimension
    if is_multi_dim:
        print(f"Initializing multi-head model with {n_dims} dimensions")
        # This function should wrap base_policy into an instance of MultiHeadPreferenceModel.
